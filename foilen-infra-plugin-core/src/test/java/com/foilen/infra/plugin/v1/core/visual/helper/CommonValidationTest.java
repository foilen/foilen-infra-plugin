...
public class CommonValidationTest {
    ...
    public void testValidateInEnum() {
        assertInEnum("A", true, AnEnum.values());
        assertInEnum("B", true, AnEnum.values());
        assertInEnum("a", false, AnEnum.values());
        assertInEnum("i", false, AnEnum.values());

        assertInEnum(Arrays.asList("A", "i"), Arrays.asList(true, false), AnEnum.values());
    }
